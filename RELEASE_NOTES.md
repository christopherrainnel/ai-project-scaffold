...
- Confirmed these remain Tier1-only and were not added to free:
  - `project_templates/docs/PROJECT_BRIEF.md`
  - `project_templates/docs/STACK_SUMMARY.md`
  - `project_templates/docs/TRIGGERS.md`
  - `project_templates/ops/prompts/project_bootstrap.md`
...
- **ai-project-scaffold-tier1** (AI-guided, Bootstrap Protocol)
  - ✅ Generator updated (with tier1-specific features preserved)
  - ✅ .exe build hardened
  - ✅ v2.5 templates included (project_bootstrap.md unaffected)
...
- Tier1 Bootstrap Protocol unaffected by v2.5 (maintains backward compat)
